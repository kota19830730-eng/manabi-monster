...
MQ.ui.dex = (function () {
  ...
  function feverSection(player) {
    ...
    return h('div', { class: 'pfever' }, [
      ...
      h('p', { class: 'note', text: 'ザコも ボスも 3問ごとに「こうげき」して きます。その 問題に 1回めで 正解すると カウンター（けいけんち 1.5倍・ボスには 2ダメージ）。ボスは 3問めから「たての かまえ」「ぶんしん」「なかまを よぶ」の わざも 使います（どれも 正解すると ボーナス）。まちがえても 演出だけで、うしなう ものは ありません。こわがる 子には「なし」に できます（中ボスと 弱点は そのまま）。' }),
      h('div', { class: 'termrow' }, [[true, 'つける'], [false, 'なし']].map(function (t) {
