...
MQ.eigo4 = {
  questions: [
    /* ===== 追加（v6.1 ボリュームアップ）===== */
    { stage: 1, lv: 1, unit: '世界のあいさつ', text: '"Annyeonghaseyo（アンニョンハセヨ）" は どの 国の あいさつ？', choices: ['かんこく', '中国', 'フランス', 'インド'], note: 'かんこくの「こんにちは」です。' },
    { stage: 1, lv: 1, unit: '世界のあいさつ', text: '"Ciao（チャオ）" は どの 国の あいさつ？', choices: ['イタリア', 'ドイツ', 'スペイン', 'アメリカ'], note: 'イタリアの きがるな あいさつです。' },
    { stage: 1, lv: 1, unit: 'あそび', text: '"Let\'s play dodgeball." の いみは？', choices: ['ドッジボールを しよう', 'サッカーを しよう', 'かくれんぼを しよう', 'ボールを かたづけよう'], note: 'dodgeball ＝ ドッジボール。' },
    { stage: 1, lv: 1, unit: '天気', text: '"It\'s sunny and hot." の いみは？', choices: ['晴れて あつい', '晴れて さむい', '雨で あつい', 'くもりで すずしい'], note: 'and ＝ 〜と。天気の ことばを 2つ つなげられます。' },
    { stage: 1, lv: 1, unit: 'あいさつ', text: '"Hello." と 言われたら 何と 返す？', choices: ['Hello.', 'Goodbye.', 'Good night.', 'Sorry.'], note: 'あいさつには 同じ あいさつを 返します。' },
    { stage: 1, lv: 2, unit: '天気', text: '"How\'s the weather?" に くもりの 日に 答えるなら？', choices: ['It\'s cloudy.', 'It\'s sunny.', 'It\'s snowy.', 'It\'s hot.'], note: 'cloudy ＝ くもり。' },
    { stage: 1, lv: 2, unit: 'あそび', text: '"Let\'s play baseball." の いみは？', choices: ['野球を しよう', 'バスケを しよう', 'テニスを しよう', 'かけっこを しよう'], note: 'baseball ＝ 野球。' },
    { stage: 1, lv: 2, unit: '世界のあいさつ', text: '"Namaste（ナマステ）" は どの 国の あいさつ？', choices: ['インド', 'イタリア', 'かんこく', 'ロシア'], note: 'インドの あいさつ。手を 合わせて 言います。' },
    { stage: 1, lv: 2, unit: '天気', text: '"It\'s windy today." の いみは？', choices: ['きょうは 風が 強い', 'きょうは 晴れ', 'きょうは 雨', 'きのうは 風だった'], note: 'today ＝ きょう。windy ＝ 風の 強い。' },
    { stage: 1, lv: 2, unit: 'あそび', text: '"Let\'s make a snowman." の いみは？', choices: ['雪だるまを 作ろう', '雪がっせんを しよう', 'かまくらを 作ろう', 'スキーを しよう'], note: 'make ＝ 作る。snowman ＝ 雪だるま。' },
    { stage: 1, lv: 2, unit: 'あいさつ', text: '"Sit down, please." の "please" が あらわす ものは？', choices: ['ていねいな おねがい', 'おこって いる', 'いそいで いる', 'かなしんで いる'], note: 'please を つけると ていねいな 言い方に なります。' },
    { stage: 1, lv: 3, unit: 'あそび', text: '"It\'s rainy. Let\'s play cards." の いみは？', choices: ['雨だから トランプを しよう', '雨だから 外で 遊ぼう', '晴れたら トランプを しよう', 'カードを 買いに 行こう'], note: '天気に 合わせた あそびの さそい方です。' },
    { stage: 1, lv: 3, unit: 'あそび', text: '「おにごっこを しよう」を 英語で 言うと？', choices: ['Let\'s play tag.', 'Let\'s play cards.', 'Let\'s play soccer.', 'Let\'s go home.'], note: 'tag ＝ おにごっこ。' },
    { stage: 1, lv: 3, unit: '天気', text: '"It\'s snowy and cold." の いみは？', choices: ['雪が ふって さむい', '雪が とけて あたたかい', '雨で さむい', '風が 強くて さむい'], note: 'snowy（雪）＋ cold（さむい）。' },
    { stage: 1, lv: 3, unit: '世界のあいさつ', text: 'あいさつの とき、おじぎを する ことが 多い 国は？', choices: ['日本', 'アメリカ', 'イタリア', 'ブラジル'], note: '国に よって あくしゅ・ハグ・おじぎなど あいさつの しかたが ちがいます。' },
    { stage: 1, lv: 3, unit: 'あそび', text: '「テニスを しよう」を 英語で 言うと？', choices: ['Let\'s play tennis.', 'Let\'s play table tennis.', 'Let\'s watch tennis.', 'Let\'s buy a racket.'], note: 'tennis ＝ テニス。' },
    { stage: 2, lv: 1, unit: '時こく', text: '"It\'s 8 a.m." は 何時？', choices: ['あさ 8時', 'よる 8時', 'あさ 6時', 'ひる 12時'], note: 'a.m. ＝ 午前。' },
    { stage: 2, lv: 1, unit: '1日の生活', text: '"Lunch time." の いみは？', choices: ['ひるごはんの 時間', 'あさごはんの 時間', 'おやつの 時間', 'ねる 時間'], note: 'lunch ＝ ひるごはん。' },
    { stage: 2, lv: 1, unit: '曜日', text: '「日曜日」を 英語で いうと？', choices: ['Sunday', 'Saturday', 'Monday', 'Sun day off'], note: 'Sunday ＝ 日曜日。' },
    { stage: 2, lv: 1, unit: '1日の生活', text: '"Study time." の いみは？', choices: ['べんきょうの 時間', 'あそびの 時間', 'そうじの 時間', 'きゅうけいの 時間'], note: 'study ＝ べんきょうする。' },
    { stage: 2, lv: 1, unit: '1日の生活', text: '"Bath time." の いみは？', choices: ['おふろの 時間', 'ねる 時間', 'ごはんの 時間', 'あそぶ 時間'], note: 'bath ＝ おふろ。' },
    { stage: 2, lv: 1, unit: '曜日', text: '1週間は 何日？', choices: ['7日', '5日', '6日', '10日'], note: 'Sunday から Saturday まで 7つの 曜日が あります。' },
    { stage: 2, lv: 2, unit: '時こく', text: '"It\'s seven fifteen." は 何時何分？', choices: ['7時15分', '7時50分', '5時17分', '15時7分'], note: 'seven（7）＋ fifteen（15）。時 → 分の じゅんに 言います。' },
    { stage: 2, lv: 2, unit: '曜日', text: '"Saturday" の つぎの 日は？', choices: ['Sunday', 'Friday', 'Monday', 'Thursday'], note: '土曜日の つぎは 日曜日。' },
    { stage: 2, lv: 2, unit: '曜日', text: '"Monday" の 前の 日は？', choices: ['Sunday', 'Tuesday', 'Saturday', 'Friday'], note: '月曜日の 前は 日曜日。' },
    { stage: 2, lv: 2, unit: '1日の生活', text: '"Dinner time." の いみは？', choices: ['ばんごはんの 時間', 'ひるごはんの 時間', 'あさごはんの 時間', 'おやつの 時間'], note: 'dinner ＝ ばんごはん（夕食）。' },
    { stage: 2, lv: 2, unit: '時こく', text: '"It\'s 10 p.m." は いつ？', choices: ['よるの 10時', 'あさの 10時', 'ひるの 10時すぎ', 'あさの 8時'], note: 'p.m. ＝ 午後。よるの 時こくです。' },
    { stage: 2, lv: 3, unit: '曜日', text: '「金曜日が 好きです」を 英語で 言うと？', choices: ['I like Fridays.', 'I like Mondays.', 'Friday is me.', 'Like Friday you.'], note: 'I like 〜. で 好きな ものを つたえられます。' },
    { stage: 2, lv: 3, unit: '1日の生活', text: '"It\'s time for bed." の いみは？', choices: ['ねる 時間だよ', '起きる 時間だよ', 'ごはんの 時間だよ', 'ベッドを 買おう'], note: 'time for 〜 ＝ 〜の 時間。bed ＝ ベッド。' },
    { stage: 2, lv: 3, unit: '時こく', text: '"What time is it?" に「3時です」と 答えるなら？', choices: ['It\'s three o\'clock.', 'It\'s three days.', 'Three please.', 'I\'m three.'], note: 'o\'clock ＝ 〜時 ちょうど。' },
    { stage: 2, lv: 3, unit: '時こく', text: '"a.m." と "p.m." の 区切りに なる 時こくは？', choices: ['ひるの 12時', 'あさの 6時', 'よるの 8時', 'あさの 10時'], note: 'ひるの 12時より 前が a.m.（午前）、あとが p.m.（午後）です。' },
    { stage: 2, lv: 3, unit: '1日の生活', text: '「9時に ねます」を 英語で 言うと？', choices: ['I go to bed at nine.', 'I get up at nine.', 'I eat at nine.', 'Nine is bed.'], note: 'go to bed ＝ ねる。at 〜 ＝ 〜時に。' },
    { stage: 3, lv: 1, unit: '文ぼう具', text: '"pen" の いみは？', choices: ['ペン', 'えんぴつ', 'ふで', 'クレヨン'], note: 'pen ＝ ペン。pencil ＝ えんぴつ。' },
    { stage: 3, lv: 1, unit: '文ぼう具', text: '"book" の いみは？', choices: ['本', 'ノート', 'かばん', 'つくえ'], note: 'book ＝ 本。notebook ＝ ノート。' },
    { stage: 3, lv: 1, unit: '文ぼう具', text: '"bag" の いみは？', choices: ['かばん', 'ぼうし', 'くつ', '筆箱'], note: 'bag ＝ かばん・ふくろ。' },
    { stage: 3, lv: 1, unit: 'アルファベット', text: '大文字 "C" の 小文字は？', choices: ['c', 'e', 'o', 'g'], note: 'C と c は 同じ 形で 大きさが ちがいます。' },
    { stage: 3, lv: 1, unit: '文ぼう具', text: '"pencil case" の いみは？', choices: ['筆箱', 'ランドセル', '教科書', '黒板'], note: 'pencil（えんぴつ）＋ case（入れ物）。' },
    { stage: 3, lv: 2, unit: '文ぼう具', text: '"pencil sharpener" の いみは？', choices: ['えんぴつけずり', 'えんぴつ', 'けしゴム', 'はさみ'], note: 'sharpen ＝ とがらせる。' },
    { stage: 3, lv: 2, unit: 'アルファベット', text: '小文字 "b" の 大文字は？', choices: ['B', 'D', 'P', 'R'], note: 'b の 大文字は B。d（D）と まちがえやすいので 注意。' },
    { stage: 3, lv: 2, unit: 'アルファベット', text: 'アルファベットの じゅんで 10ばんめの 文字は？', choices: ['J', 'I', 'K', 'H'], note: 'A B C D E F G H I J … で 10ばんめは J です。' },
    { stage: 3, lv: 2, unit: '文ぼう具', text: '"desk" の いみは？', choices: ['つくえ', 'いす', 'たな', 'ドア'], note: 'desk ＝ つくえ。chair ＝ いす。' },
    { stage: 3, lv: 2, unit: '文ぼう具', text: '"chair" の いみは？', choices: ['いす', 'つくえ', 'まど', 'ゆか'], note: 'chair ＝ いす。' },
    { stage: 3, lv: 2, unit: 'やりとり', text: '"I have a red pen." の いみは？', choices: ['赤い ペンを 持って いる', '赤い ペンが ほしい', 'ペンが 赤く なった', '赤ペンを なくした'], note: 'have ＝ 持って いる。' },
    { stage: 3, lv: 3, unit: 'アルファベット', text: 'アルファベットの じゅんで "G" の つぎは？', choices: ['H', 'I', 'F', 'J'], note: '… E F G H I … の じゅんです。' },
    { stage: 3, lv: 3, unit: 'やりとり', text: '"This is for you." の いみは？', choices: ['これを あなたに どうぞ', 'これは わたしのです', 'これは 何ですか', 'これを 返して'], note: 'プレゼントなどを わたす ときの ことばです。' },
    { stage: 3, lv: 3, unit: 'たずねる', text: '"How many rulers?" の いみは？', choices: ['ものさしは 何本？', 'ものさしは どこ？', 'ものさしは いくら？', 'だれの ものさし？'], note: 'How many 〜? ＝ いくつの 〜？' },
    { stage: 3, lv: 3, unit: 'やりとり', text: '「ノートを 2さつ 持って います」を 英語で 言うと？', choices: ['I have two notebooks.', 'I want two notebooks.', 'Two notebooks, please.', 'I like notebooks.'], note: 'have ＝ 持って いる。two ＝ 2。' },
    { stage: 3, lv: 3, unit: 'アルファベット', text: 'アルファベットの じゅんで "R" の 前は？', choices: ['Q', 'S', 'P', 'T'], note: '… P Q R S … の じゅんです。' },
    { stage: 4, lv: 1, unit: '野さいとくだもの', text: '"banana" の いみは？', choices: ['バナナ', 'りんご', 'もも', 'パイナップル'], note: 'banana ＝ バナナ。' },
    { stage: 4, lv: 1, unit: '野さいとくだもの', text: '"strawberry" の いみは？', choices: ['いちご', 'さくらんぼ', 'りんご', 'ぶどう'], note: 'strawberry ＝ いちご。' },
    { stage: 4, lv: 1, unit: '学校の中', text: '"gym" の いみは？', choices: ['体育館', '図書室', '教室', '校庭'], note: 'gym ＝ 体育館。' },
    { stage: 4, lv: 1, unit: '学校の中', text: '"classroom" の いみは？', choices: ['教室', '体育館', '校門', 'ろうか'], note: 'class（クラス）＋ room（へや）。' },
    { stage: 4, lv: 1, unit: 'ほしいもの', text: '"I want an apple." の いみは？', choices: ['りんごが ほしい', 'りんごを 食べた', 'りんごが 好き', 'りんごを あげる'], note: 'want ＝ ほしい。' },
    { stage: 4, lv: 2, unit: '野さいとくだもの', text: '"cabbage" の いみは？', choices: ['キャベツ', 'レタス', 'はくさい', 'ほうれんそう'], note: 'cabbage ＝ キャベツ。' },
    { stage: 4, lv: 2, unit: '野さいとくだもの', text: '"pumpkin" の いみは？', choices: ['かぼちゃ', 'メロン', 'すいか', 'なす'], note: 'pumpkin ＝ かぼちゃ。ハロウィンでも おなじみ。' },
    { stage: 4, lv: 2, unit: '野さいとくだもの', text: '"peach" の いみは？', choices: ['もも', 'なし', 'いちご', 'うめ'], note: 'peach ＝ もも。' },
    { stage: 4, lv: 2, unit: '学校の中', text: '"restroom" の いみは？', choices: ['トイレ', '休けい室', 'ほけん室', 'ねる へや'], note: 'rest（休む）＋ room ですが、トイレの いみで つかいます。' },
    { stage: 4, lv: 2, unit: '学校の中', text: '"entrance" の いみは？', choices: ['入り口（げんかん）', '出口', '階だん', '屋上'], note: 'entrance ＝ 入り口。学校の げんかんも entrance。' },
    { stage: 4, lv: 2, unit: '1日の生活', text: '"I wash my hands." の いみは？', choices: ['手を あらう', '顔を あらう', '服を あらう', 'さらを あらう'], note: 'wash ＝ あらう。hands ＝ 手。' },
    { stage: 4, lv: 3, unit: 'ほしいもの', text: '"What do you want?" に「メロンが 2つ ほしい」と 答えるなら？', choices: ['I want two melons.', 'I have two melons.', 'Two apples, please.', 'I like melons.'], note: 'want ＝ ほしい。数も いっしょに つたえられます。' },
    { stage: 4, lv: 3, unit: '道あんない', text: '「左に まがって」を 英語で 言うと？', choices: ['Turn left.', 'Turn right.', 'Go straight.', 'Stop here.'], note: 'turn ＝ まがる。left ＝ 左。' },
    { stage: 4, lv: 3, unit: '学校の中', text: '"arts and crafts room" の いみは？', choices: ['図工室', '音楽室', '理科室', '家庭科室'], note: 'arts and crafts ＝ 図画工作。' },
    { stage: 4, lv: 3, unit: '学校の中', text: '"teachers\' office" の いみは？', choices: ['しょくいん室', '校長室', 'ほけん室', '放送室'], note: 'teacher（先生）たちの へや ＝ しょくいん室。' },
    { stage: 4, lv: 3, unit: 'ほしいもの', text: '"I want three carrots." の いみは？', choices: ['にんじんが 3本 ほしい', 'にんじんを 3本 食べた', 'にんじんが 3本 ある', 'にんじんは きらい'], note: 'want ＝ ほしい。three ＝ 3。' },
    /* ===== 1 世界の あいさつと 天気 ===== */
    /* -- やさしい -- */
