...
MQ.treasure = (function () {
  ...
  const list = [
    ...
    /* ---- 小6（v10.6〜v11.0・やみの 大陸・32） ---- */
    { stage: 'sansu6-1', id: 'tr6-taisho', name: '対称の かがみ', shape: 'gem', colors: c('#A96BE0', '#5A2D8A') },
    { stage: 'sansu6-2', id: 'tr6-moji', name: '文字式の 書', shape: 'book', colors: c('#8FD3FF', '#3E7FB0') },
    { stage: 'sansu6-3', id: 'tr6-bkake', name: '分数かけ算の 玉', shape: 'orb', colors: c('#FF8A5A', '#A83A1A') },
    { stage: 'sansu6-4', id: 'tr6-bwari', name: '分数わり算の かぎ', shape: 'key', colors: c('#C9D3DC', '#6B7C8C') },
    { stage: 'sansu6-5', id: 'tr6-shosu', name: '小数と 分数の しずく', shape: 'potion', colors: c('#6FD3FF', '#2E7FB0') },
    { stage: 'sansu6-6', id: 'tr6-hi', name: '比の 天びん', shape: 'hourglass', colors: c('#B8A060', '#6E5A2A') },
    { stage: 'sansu6-7', id: 'tr6-kakudai', name: '拡大の レンズ', shape: 'ring', colors: c('#8FD3FF', '#4FA3E0') },
    { stage: 'sansu6-8', id: 'tr6-enmen', name: '円の 面積の わ', shape: 'ring', colors: c('#F2C14E', '#B8860B') },
    { stage: 'sansu6-9', id: 'tr6-taiseki', name: '体積の はこ', shape: 'orb', colors: c('#C89A5B', '#7A5326') },
    { stage: 'sansu6-10', id: 'tr6-oyoso', name: 'およその らしんばん', shape: 'compass', colors: c('#E0846B', '#8A3A24') },
    { stage: 'sansu6-11', id: 'tr6-hirei', name: '比例の はね', shape: 'feather', colors: c('#4F8CFF', '#1F4FB0') },
    { stage: 'sansu6-12', id: 'tr6-hanhi', name: '反比例の すず', shape: 'bell', colors: c('#C0A060', '#7A5326') },
    { stage: 'sansu6-13', id: 'tr6-baai', name: '場合の さいころ', shape: 'gem', colors: c('#4CD164', '#1E7A3C') },
    { stage: 'sansu6-14', id: 'tr6-data', name: 'データの まきもの', shape: 'scroll', colors: c('#D8B889', '#8A5A2B') },
    { stage: 'sansu6-15', id: 'tr6-tani', name: 'たんいの ほし', shape: 'star', colors: c('#FFD166') },
    { stage: 'kokugo6-1', id: 'tr6-yomi', name: 'やみの 読みの 書', shape: 'book', colors: c('#3E7FD0', '#1F4FB0') },
    ...
    { stage: 'rika6-4', id: 'tr6-teko', name: 'てこの 歯車', shape: 'ring', colors: c('#B8A060', '#6E5A2A') },
    { stage: 'shakai6-1', id: 'tr6-kenpo', name: '憲法の 書', shape: 'book', colors: c('#3E9A6B', '#1E5A3C') },
    { stage: 'shakai6-2', id: 'tr6-kodai', name: '古代の 土器', shape: 'orb', colors: c('#C89A5B', '#7A5326') },
    { stage: 'shakai6-3', id: 'tr6-samurai', name: '武士の かぶと', shape: 'crown', colors: c('#7E8898', '#454D5C') },
    { stage: 'shakai6-4', id: 'tr6-mirai', name: '未来の コンパス', shape: 'compass', colors: c('#4F8CFF', '#1F4FB0') },
    { stage: 'eigo6-1', id: 'tr6-me', name: '自分の ほし', shape: 'star', colors: c('#FFD166') },
    { stage: 'eigo6-2', id: 'tr6-tabi', name: '旅の かぎ', shape: 'key', colors: c('#C9D3DC', '#6B7C8C') },
    { stage: 'eigo6-3', id: 'tr6-natsu', name: '夏の しずく', shape: 'potion', colors: c('#6FD3FF', '#2E7FB0') },
    { stage: 'eigo6-4', id: 'tr6-omoide', name: '思い出の すず', shape: 'bell', colors: c('#C0A060', '#7A5326') },
    { stage: 'tower6', id: 'tr6-hades', name: 'めいかいの 王かん', shape: 'crown', colors: c('#A96BE0', '#241E36') },
