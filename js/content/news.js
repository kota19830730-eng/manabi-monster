...
MQ.news = (function () {
  ...
  const list = [
    ...
    /* v13.46（sw 205）… ★3 の ところの くり返しは コイン 1まい（docs/v14.31コイン稼ぎメモ.md）。
       ばつでは なく「まだ ★3 で ない ところへ」と 前向きに 出す */
    {
      v: 'v13.46', date: '2026-09-25', sw: 205,
      items: [
        { kind: 'coin', id: 'coin', title: 'コインは あたらしい ところで',
          text: 'もう ★3 の ところを くりかえしても コインは 1まい。まだ ★3 で ない ところで たくさん もらえるよ。' }
      ]
    },
    /* v13.47（sw 208）… さんすう・りか・しゃかいの 問題文を 声で 読む「きく」（docs/v14.34問題文のよみあげメモ.md） */
    {
      v: 'v13.47', date: '2026-09-26', sw: 208,
      items: [
        { kind: 'hero', id: 'hero', title: 'もんだいを こえで きける',
          text: 'さんすう・りか・しゃかいの ながい もんだいに「きく」が ついたよ。おすと こえで よんで くれる。' }
      ]
    },
    /* v13.48（sw 209）… 相棒の 存在感：大きく・レベルで 強く・しゃべる（docs/v14.35相棒の存在感メモ.md） */
    {
      v: 'v13.48', date: '2026-09-26', sw: 209,
      items: [
        { kind: 'mons', id: 'drago-1', title: 'あいぼうが 大きく なった！',
          text: 'あいぼうが となりで いっしょに たたかうよ。レベルが 上がると つよく なって、はなしかけて くれる！' }
      ]
    },
    /* v13.49（sw 210）… 相棒の ひっさつ と きずな（docs/v14.36相棒のひっさつときずなメモ.md） */
    {
      v: 'v13.49', date: '2026-09-26', sw: 210,
      items: [
        { kind: 'mons', id: 'drago-1', title: 'あいぼうを タッチで ひっさつ！',
          text: 'あいぼうが ひかったら タッチ！ つぎに せいかいすると あいぼうの ひっさつが 出るよ。' },
        { kind: 'mons', id: 'drago-2', title: 'あいぼうとの きずな',
          text: 'いっしょに たたかうと ♥が たまるよ。♥が ふえると あいぼうが もっと たすけて くれる！' }
      ]
    },
    /* v13.50（sw 212）… 相棒の ターン（docs/v14.37相棒のターンメモ.md） */
    {
      v: 'v13.50', date: '2026-09-26', sw: 212,
      items: [
        { kind: 'mons', id: 'drago-1', title: 'あいぼうの ターン！',
          text: 'あいぼうを タッチすると あいぼうが まえに 出るよ。つぎの せいかいは あいぼうだけの 大きな わざ！' },
        { kind: 'mons', id: 'wolf-gray', title: 'あいぼうごとに ちがう わざ',
          text: 'ドラゴンは ほのお、オオカミは きば。あいぼうの しゅるいで わざが かわるよ。' }
      ]
    },
    /* v13.51（sw 213）… 相棒が たすけて くれる（docs/v14.38相棒がたすけるメモ.md） */
    {
      v: 'v13.51', date: '2026-09-26', sw: 213,
      items: [
        { kind: 'mons', id: 'drago-1', title: 'こまったら あいぼうを タッチ',
          text: 'わざが たまって いない ときに タッチすると ヒントを おしえて くれるよ。' },
        { kind: 'mons', id: 'golem-gray', title: 'あいぼうが かばって くれる',
          text: 'まちがえても いちど あいぼうが かばって コンボを まもって くれるよ。' }
      ]
    }
  ];
