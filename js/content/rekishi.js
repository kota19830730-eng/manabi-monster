...
MQ.rekishi = (function () {
  ...
  const PICS = {
    ...
    kango: ['ほりと さく', 'もの', 'むらを 守った ほり（みぞ）と 木の さく'],
    yakata: ['武士の やかた', 'もの', 'ほりと へいで かこんだ 武士の すまい（復元）'],
    ...
    heian: ['平安京', 'もの', '道が ごばんの 目の 都（復元模型）'],
  ...
  const CREDITS = {
    ...
    kango: { lic: 'CC BY 3.0', by: '小池 隆', file: '吉野ヶ里遺跡環濠.JPG' },
    yakata: { lic: 'CC0', by: '先従隗始', file: "Historic Ruin Ema's House Park (Ema-shi Shimoyakata) 20240505 07.jpg" },
    ...
    heian: { lic: 'Public domain', by: 'Wikiwikiyarou', file: 'Daidairi of Heiankyo.jpg' },
