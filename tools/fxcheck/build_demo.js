...
let out = '<title>ひっさつわざ 3D の 見本</title>\n';
...
out += '</div>\n<script>\n' + (fs.existsSync(__dirname + '/sounds.js') ? fs.readFileSync(__dirname + '/sounds.js', 'utf8') : 'window.__SND = {};') + '\n</script>\n<script>\n' + fs.readFileSync(__dirname + '/demo_panel.js', 'utf8') + '\n</script>\n';
fs.writeFileSync(__dirname + '/demo3d.html', out);
